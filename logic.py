...
class DB_Map():
    ...
    def draw_distance(self, city1, city2):
        ...
        plt.plot([city1_coords[1] , city2_coords[1]], [city1_coords[0] , city2_coords[0]],
                 color="red", linewidth=2, marker='o', transform=ccrs.Geocentric())
        plt.text(city1_coords[1] + 3, city1_coords[0] + 12, city1, horizontalaligment='left', transform=ccrs.Geodetic())
        plt.text(city2_coords[1] + 3, city2_coords[0] + 12, city2, horizontalaligment='left', transform=ccrs.Geodetic())
        plt.savefing('distance_map.png')
        plt.close
